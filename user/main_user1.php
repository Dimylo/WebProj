...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="admin888.css">
...
<!-- <input type="hidden" id="hdnSession" value="@Request.RequestContext.HttpContext.Session['id']" />    <button class="w3-btn" id="gather">HeatMap</button> -->
    <div class="fixed-bottom" id="mapid" style="width:50%; height:200px; align:"center";  " ></div>
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.3.4/dist/leaflet.css"/>
